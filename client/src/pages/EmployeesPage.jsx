  ...
  if (error) {
    return (
      <div className="card p-12 text-center">
        ...
        <h3 className="text-lg font-medium text-neutral-700 mb-1">Failed to Load Employees</h3>
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-neutral-500 mt-1">{employees.length} employees across {Object.keys(roleGroups).length} roles</p>
      </div>
        ...
        <div className="lg:col-span-2 space-y-4">
          {Object.entries(roleGroups)
            ...
            <div key={role} className="card">
              <div className="px-5 py-3 border-b border-neutral-100 bg-neutral-50 rounded-t-xl">
                <h3 className="text-sm font-semibold text-neutral-700">{role} ({emps.length})</h3>
              </div>
              <div className="divide-y divide-neutral-100">
                {emps.map(emp => (
                  <button
                    ...
                    className={cn(
                      'w-full flex items-center gap-4 px-5 py-3 hover:bg-neutral-50 transition-colors text-left',
                  ...
                  >
                    ...
                    <div className="text-right text-sm">
                      <div className="text-neutral-600">{emp.territory_name || 'N/A'}</div>
                      <div className="text-xs text-neutral-400">{formatCurrency(emp.base_salary)}/mo</div>
                    </div>
          ...
          {selectedEmployee ? (
            <div className="card p-5 md:sticky md:top-6 space-y-4">
              <div className="text-center pb-4 border-b border-neutral-100">
                ...
                <h3 className="text-lg font-semibold text-neutral-900">{selectedEmployee.name}</h3>
                <p className="text-sm text-neutral-500">{selectedEmployee.role_name}</p>
              </div>
            ...
            <div className="card p-8 text-center">
              ...
              <p className="text-neutral-500">Select an employee to view details</p>
            </div>
          )}
        </div>
      </div>
